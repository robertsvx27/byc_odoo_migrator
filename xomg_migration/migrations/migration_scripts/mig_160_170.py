...
def _check_open_form(
    ...
    file_paths = tools.get_files(module_path, (reformat_file_ext,))
...
def migrate_file_v160_v170(env, base_path, module_name=None) -> bool:
    _check_open_form(env._logger, base_path, module_name, env.dry_run)
    _reformat_read_group(env._logger, base_path, module_name, env.dry_run)
    _move_attrs_to_attributes(env._logger, base_path, module_name, env.dry_run)

    return True

PythonTransformer.migrate_file_v160_v170 = migrate_file_v160_v170