...
def _reformat_deprecated_tags(
    ...
    file_paths =  tools.get_files(module_path, (reformat_file_ext,)) # _get_files(module_path, reformat_file_ext)
...
def migrate_file_v130_v140(env, base_path, module_name=None) -> bool:
    _reformat_deprecated_tags(env._logger, base_path, module_name, env.dry_run)
    return True


PythonTransformer.migrate_file_v130_v140 = migrate_file_v130_v140